...
contract ReceiveFallbackTest is Test {
    ...
    function testFallbackFunction() public {
        ...
        vm.prank(user1);
        (bool success,) =
            address(receiveFallback).call{value: 0.3 ether}(abi.encodeWithSignature("nonExistentFunction()"));
    ...
    function testMultipleTransactions() public {
        ...
        vm.prank(user2);
        (bool success2,) = address(receiveFallback).call{value: 0.3 ether}(abi.encodeWithSignature("fakeFunction()"));
        assertTrue(success2);
    ...
    function testStatsFunction() public {
        ...
        vm.prank(user1);
        (bool success2,) = address(receiveFallback).call{value: 0.2 ether}(abi.encodeWithSignature("testFunction()"));
        assertTrue(success2);
    ...
    function testReceiveVsFallback() public {
        ...
        vm.prank(user1);
        (bool success2,) =
            address(receiveFallback).call{value: 0.3 ether}(abi.encodeWithSignature("someFunction(uint256)", 123));
        assertTrue(success2);
